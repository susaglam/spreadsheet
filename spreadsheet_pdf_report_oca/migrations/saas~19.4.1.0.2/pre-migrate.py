...
"""saas~19.4.1.0.2: let this upgrade create its NEW ir.ui.view records
(``report_spreadsheet_pdf_placeholder``) on databases where ``website`` is installed.
