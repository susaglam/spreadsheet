...
.. |badge3| image:: https://img.shields.io/badge/version-saas~19.4-blue.png
   :target: https://github.com/OCA/spreadsheet/tree/saas-19.4/spreadsheet_campaign_roi_oca
   :alt: OCA/spreadsheet
...
Marketing campaign performance tracking (sent/delivered/opened/clicked).
...
Auto-installs with ``mass_mailing``.
...
* ROI calculation with sale attribution
